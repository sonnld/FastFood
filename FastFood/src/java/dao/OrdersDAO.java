...
public class OrdersDAO extends MyDAO {
    ...
    public Vector<Orders> getOrderByStatus(String status) {
       Vector<Orders> orderList = new Vector<>();
        ...
        try {
            ...
            if (rs.next()) {
               ...
               orderList.add(new Orders(id, userID, name, name, address, orderDate, totalAmount, statusID, username, statusName));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
