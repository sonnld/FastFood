                        ...
                        <div class="col-lg-9">
                            ...
                            <form action="billlist" method="post">
                                <div class="menu_box_2">
                                    <input  name="odid" class="form_1" type="number" value="${txt}" placeholder="Search by ODID">
                                ...
                                <form action="billlist" method="POST">
                                     <div>
                                    <input type="radio" name="check" value="wait" /> Wait
                                    <input type="radio" name="check" value="process" />process
